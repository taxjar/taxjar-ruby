...
describe Taxjar::API::Request do
  describe 'attr_accessors' do
    let(:client) { Taxjar::Client.new }
    let(:subject) do
      Taxjar::API::Request.new(:get, '/api_path', 'object')
    end
    ...
    describe 'options' do
      ...
      it 'should have options if passed to constructor' do
        ...
        subject = Taxjar::API::Request.new(:get, '/api_path', 'object', options)
      ...
      context 'timeout' do
        it 'should initialize nil timeout if not set' do
          client = Taxjar::Client.new
          subject = Taxjar::API::Request.new(:get, '/api_path', 'object', {})
  ...
  describe '#perform' do
      ...
      it 'should return a body if no errors' do
        stub_request(:get, 'https://api.taxjar.com/api_path')
          .with(headers: { 'Authorization' => 'Bearer AK', 'Connection' => 'close',
                           'Host' => 'api.taxjar.com',
                           'User-Agent' => "TaxjarRubyGem/#{Taxjar::Version}" })
    ...
    context 'with POST' do
      let(:client) { Taxjar::Client.new }
      let(:subject) do
        Taxjar::API::Request.new(:post, '/api_path', 'object', city: 'New York')
      end
